...
* Processed **303,635,907 objects** during its lifetime.
* Crawled **87,570,469 URLs** on the Interwebs.
* Handled **83,894 `whois` connections** via IPv4/IPv6.
* Handled **21,288 API requests** via HTTPS.
