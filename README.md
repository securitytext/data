...
* Processed **280,312,593 objects** during its lifetime.
* Crawled **85,953,831 URLs** on the Interwebs.
* Handled **75,185 `whois` connections** via IPv4/IPv6.
* Handled **14,081 API requests** via HTTPS.
