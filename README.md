...
* Processed **303,044,935 objects** during its lifetime.
* Crawled **87,413,937 URLs** on the Interwebs.
* Handled **83,515 `whois` connections** via IPv4/IPv6.
* Handled **21,001 API requests** via HTTPS.
